...
return array(
  ...
  |--------------------------------------------------------------------------
  |
  | The installer module uses this information to know if the application is
  | already installed. Do not change this value it's used and set by the 
  | installer module only.
  |
  */
  ...
  */
  ...
  'key' => 'S1QOfa9FkZNNqlOnhsiYYw6lrrikSRDp',
